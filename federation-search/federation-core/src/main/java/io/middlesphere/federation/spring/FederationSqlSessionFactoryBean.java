 ...
 */
public class FederationSqlSessionFactoryBean implements FactoryBean<SqlSessionFactory>, InitializingBean, ApplicationListener<ContextRefreshedEvent> {
    private static final Logger LOGGER = LoggerFactory.getLogger(FederationSqlSessionFactoryBean.class);
    ...
    private FederationDataSource dataSource;
    ...
    private String environment = FederationSqlSessionFactoryBean.class.getSimpleName();
     ...
     */
    public void setDataSource(FederationDataSource dataSource) {
    ...
    protected SqlSessionFactory buildSqlSessionFactory() throws Exception {
        ...
        targetConfiguration.setEnvironment(new Environment(this.environment, new JdbcTransactionFactory(), this.dataSource));

 ...
 * {@link MapperScannerConfigurer} via {@link FederationMapperScannerRegistrar}.
 * <p>
 ...
 * @since 1.2.0
 *
 * @see FederationMapperScannerRegistrar
 * @see MapperFactoryBean
 */
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.TYPE)
@Documented
@Import(FederationMapperScannerRegistrar.class)
@Repeatable(FederationMapperScans.class)
public @interface FederationMapperScan {

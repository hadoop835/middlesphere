 ...
 */
package io.middlesphere.federation.spring.annotation;
...
import io.middlesphere.federation.spring.mapper.ClassPathMapperScanner;
import io.middlesphere.federation.spring.mapper.MapperFactoryBean;
import io.middlesphere.federation.spring.mapper.MapperScannerConfigurer;
 ...
 * @since 1.2.0
 */
public class FederationMapperScannerRegistrar implements ImportBeanDefinitionRegistrar, ResourceLoaderAware {
    ...
    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
        var mapperScanAttrs = AnnotationAttributes
                .fromMap(importingClassMetadata.getAnnotationAttributes(FederationMapperScan.class.getName()));
    ...
    private static String generateBaseBeanName(AnnotationMetadata importingClassMetadata, int index) {
        return importingClassMetadata.getClassName() + "#" + FederationMapperScannerRegistrar.class.getSimpleName() + "#" + index;
    }
    ...
    /**
     * A {@link FederationMapperScannerRegistrar} for {@link FederationMapperScans}.
     *
     * @since 2.0.0
     */
    static class RepeatingRegistrar extends FederationMapperScannerRegistrar {
        @Override
        public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
            var mapperScansAttrs = AnnotationAttributes
                    .fromMap(importingClassMetadata.getAnnotationAttributes(FederationMapperScans.class.getName()));
